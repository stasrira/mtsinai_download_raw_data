...
DLD_URL="https://wangy33.u.hpc.mssm.edu/10X_Single_Cell_RNA/TD01119_DARPA_scATAC/" #remote web folder where from data is picked up
TRG_FLD="/ext_data/shared/ECHO/HIV/HI/PBMC/scatac-seq" #local folder where to data is being downloaded
#========================
