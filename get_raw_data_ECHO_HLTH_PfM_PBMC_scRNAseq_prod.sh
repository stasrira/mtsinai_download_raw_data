...
DLD_URL="https://wangy33.u.hpc.mssm.edu/10X_Single_Cell_RNA/TD00986_DARAPPilot/" #remote web folder where from data is picked up
TRG_FLD="/ext_data/shared/ECHO/HLTH/PfM/PBMC/scrna-seq" #local folder where to data is being downloaded
#========================
